<template>
	<div>
		...
		<el-row style="margin: 20px 0" flex justify="space-between">
			<el-col :span="6"><el-button type="primary" size="default" :loading="state.loading" @click="action('add')">添加</el-button></el-col>
		...
		<content-table :api-query="apiQuery" :query-name="pageName" :init-table="initTable">
			<template #handle="{ row }">
				<el-row flex justify="space-between" align="middle">
					<el-col :span="10"><el-button type="primary" size="default" :loading="state.loading" @click="action('edit', row)">编辑</el-button></el-col>
