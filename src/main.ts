...
async function bootstrap() {
	...
	/**
	 * @description 配置静态资源路径: https://docs.nestjs.cn/8/techniques?id=mvc%e6%a8%a1%e5%9e%8b-%e8%a7%86%e5%9b%be%e6%8e%a7%e5%88%b6%e5%99%a8
	 * @example http://localhost:5051/public/upload/2024-07-16/1.jpg
	 */
	//
