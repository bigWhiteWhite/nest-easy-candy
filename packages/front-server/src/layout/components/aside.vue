	...
	<div v-show="!isTagsViewCurrentFull" class="h100">
		<el-aside class="layout-aside" :class="setCollapseStyle">
			...
			<el-scrollbar ref="layoutAsideScrollbarRef" class="flex-auto" @mouseenter="onAsideEnterLeave(true)" @mouseleave="onAsideEnterLeave(false)">
				<nav-menu-vertical :menu-list="state.menuList" />
			</el-scrollbar>
		</el-aside>
	</div>
</template>
...
import navMenuVertical from '@/layout/navMenu/vertical.vue'
...
const onAsideEnterLeave = (bool: Boolean) => {
	...
	useRoutesList().setColumnsMenuHover(bool)
}
// 路由过滤递归函数
