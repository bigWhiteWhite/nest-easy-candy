		...
		<div class="layout-lock-screen">
			...
			>
				...
				<div class="layout-lock-screen-date-top">
					<svg-icon icon-name="ele-Top"></svg-icon>
			...
			<transition name="el-zoom-in-center">
				<div v-show="state.isShowLoockLogin" class="layout-lock-screen-login">
					...
					<div class="layout-lock-screen-login-icon">
						<svg-icon icon-name="ele-Microphone"></svg-icon>
						<svg-icon icon-name="ele-AlarmClock"></svg-icon>
						<svg-icon icon-name="ele-SwitchButton"></svg-icon>
					</div>
				</div>
			</transition>
		</div>
...
<script lang="ts" setup name="layoutLockScreen">
import { nextTick, onMounted, reactive, ref, onUnmounted, getCurrentInstance } from 'vue'
